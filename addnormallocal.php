...
<head>
	<title>Add to local-normal/traveltime</title>
...
<body>
	...
	<center>
		...
		<br>
		<h3>Local - Nomal Tour </h3>
		<br>
		<table border = "2" width = "75%">
		<tr>
		<td>
		<center>
		<form class = "form-style-9" method="POST" action="localnormalsubmition.php">
			<br><br>Tour Name   : <input type="text" class="boxlog" name="t1" placeholder="Tour name"><br><br>
			Tour Code   :<input type="text" name="t2" class="boxlog" placeholder="Tour Code"><br><br>
			Tour Price  : <input type="text" name="t3" class="boxlog" placeholder="Price"><br><br>
			Description :<textarea name="t4" class="boxlog" placeholder="Description"></textarea><br><br>
