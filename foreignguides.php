...
<head>
	<title>Foreign guide/traveltime</title>
...
<body>
	...
	<a href="Home.html" class="inlinethepages">Home   >> </a><a href="category.html" class="inlinethepages"> Catogery >> </a><a href="foreignguides.php" class="inlinethepages"> Foreign Guides </a><br>
	<br><br>
	<center>
	<h2>Foreign guide Catogery</h2><br>
		...
		<?php
			...
			if($result->num_rows > 0)
			{
				while($row = $result->fetch_assoc())
				{
					...
					echo "<tr class='td'><td>".$row["Guider_id"]."</td><td>".$row["Guider_name"]."</td><td>".$row["Hire_price"]."</td><td>".$row["age"]."</td><td><button type='button' value='Hire'><a href='registerPage1.html'>Hire now</a></button></td></tr>";
