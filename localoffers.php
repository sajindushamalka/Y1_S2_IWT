...
<head>
	<title>local-offers/traveltime</title>
...
<body>
	...
	<a href="Home.html" class="inlinethepages">Home   >> </a><a href="category.html" class="inlinethepages"> Catogery >> </a><a href="localoffers.php" class="inlinethepages"> Offers </a><br>
	<br><br>
	<center>
	<h2>Local Tour Offers</h2>
		...
		<?php
			...
			if($result->num_rows > 0)
			{
				while($row = $result->fetch_assoc())
				{
					...
					echo "<tr><td>".$row["Tour_id"]."</td><td>".$row["Name"]."</td><td>".$row["Description"]."</td><td>".$row["Price"]."</td><td>".$row["Tour_code"]."</td><td><button type='button' value='Register'><a href='registerPage1.html'>Register</a></button></td></tr>";
