...
<head>
	<title>local-normal/traveltime</title>
...
<body>
	...
	<a href="Home.html" class="inlinethepages">Home   >> </a><a href="category.html" class="inlinethepages"> Catogery >> </a><a href="localnormal.php" class="inlinethepages"> Local Nomal Tour </a><br>
	<br><br>
	<center>
	<h2>Local Normal Tour category</h2>
	<table  border="2" width="80%" bgcolor="#e8e8e8" class="table2" id ="tabletable" >
		...
		<?php
			...
			if($result->num_rows > 0)
			{
				while($row = $result->fetch_assoc())
				{
					...
					echo "<tr><td>".$row["Tour_id"]."</td><td>".$row["Name"]."</td><td>".$row["Descriptiom"]."</td><td>".$row["Price"]."</td><td>".$row["Tour_code"]."</td><td><button type='button' value='Register'><a href='registerPage1.html'>Register</a></button></td></tr>";
