...
<head>
	<title>Foreign Special/traveltime</title>
...
<body>
	...
	<a href="Home.html" class="inlinethepages">Home   >> </a><a href="category.html" class="inlinethepages"> Catogery >> </a><a href="foreignspecial.php" class="inlinethepages"> Foerign Special </a><br>
	<br><br>
	<center>
	<h2>Foreign Special Tour Catogery</h2><br>
	...
	<table  border="2" width="80%" bgcolor="#e8e8e8" class="table2" >
		...
		<?php
			$sql = "select * from foreignspecial";
